...
namespace Start
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            avg1 = avg.ToString("0.0");
            
            Console.WriteLine("Media: {0}", avg1);
            if (avg  >= 7)
            {
            ...
            {   
                ...
                Console.WriteLine("Nota do exame: {0}", e.ToString("0.0"));
                
                avg = (avg + e) / 2;
                avg2 = avg.ToString("0.0");
                ...
                Console.WriteLine("Media final: " +avg2);
            }
